...
import {
    ...
    editPostController,
    getPostsController,
    getPostsLikedController,
} from "./controllers/posts.js";
import { createLikeController } from "./controllers/likes.js";
...
app.put(
    "/posts/:postId",
    async(req, res) => await editPostController(req, res)
);
app.delete(
    "/posts/:postId",
    async(req, res) => await deletePostController(req, res)
);

app.post(
    "/likes/:postId",
    async(req, res) => await createLikeController(req, res)
);
app.get(
    "/users/:userId",
    async(req, res) => await getUserInfoController(req, res)
);
